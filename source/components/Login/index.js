    ...
    render(){
        return(
            <View style={{flex:1, backgroundColor:'#e8eaed'}}>
                ...
                <ScrollView style={{width:'100%', height:'80%', paddingHorizontal: 15}}>
                    <View style={{flex:1,backgroundColor:'white', width:'100%', alignItems:'center', justifyContent: 'center',}}>
                        <View style={{alignItems:'center', justifyContent:'center', marginBottom:25, marginTop:25}}>
                            ...
                            <View style={{marginBottom:10,padding:13, borderRadius:40, width:60, height:60, backgroundColor:'#3b5998', aligItems:'center', justifyContent:'center', elevation:5}}>
                        ...
                        <View style={{ width:'100%', alignItems:'center', justifyContent:'center'}}>
                            ...
                            <TouchableOpacity onPress={()=>this.props.navigation.navigate('ForgotPassword')}>
                                <Text style={{fontSize:15, color:'orange', marginTop:15, marginBottom:20, fontWeight:'bold'}}>Lupa Password?</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
