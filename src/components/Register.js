...
import { register } from '../../configs/redux/actions/user'
                ...
                <View style={{flex:9, alignItems:'center', justifyContent: 'center'}}>
                    <View style={{flex:1,backgroundColor:'white', width:'90%', marginTop:10, alignItems:'center', justifyContent: 'center'}}>
                        ...
                        <ScrollView>
                                <View style={{flex:1}}>
                                    <View style={{flex:1, flexDirection:'row', alignItems:'center', justifyContent:'center', padding:15}}>
                                        <View style={{padding:13, borderRadius:30, width:50, height:50, backgroundColor:'#3b5998', alignItems:'center', justifyContent:'center'}}>
                                            <FontAwesome style={{textAlign:'center', flex:1,fontWeight:'bold', fontSize:25, color:'white'}} name="facebook"/>
                                        </View>
                                        <Text style={{fontSize:17, color:'#3b5998'}}>  Daftar dengan Facebook</Text>
                                    </View>
                                    <View style={{flex:1, alignItems:'center', justifyContent: 'center',width:'100%'}}>
                                        <View style={{width:'100%', height:1, backgroundColor:'#e8eaed'}} />
                                    ...
                                    <View style={{flex:1, marginTop:15, width:'100%', alignItems:'center', justifyContent:'center'}}>
                                        <TextInput style={{width:'90%', height:60}} underlineColorAndroid="#d8d8d8" placeholder="Name" onChangeText={(text)=>this.setState({name:text})}/>
                                    </View>
                                    <View style={{flex:1, marginTop:15, width:'100%', alignItems:'center', justifyContent:'center'}}>
                                        <TextInput style={{width:'90%', height:60}} underlineColorAndroid="#d8d8d8" placeholder="Email" onChangeText={(text)=>this.setState({email:text})}/>
                                    </View>
                                    <View style={{flex:1, marginTop:15, width:'100%', alignItems:'center', justifyContent:'center'}}>
                                        <TextInput style={{width:'90%', height:60}} underlineColorAndroid="#d8d8d8" placeholder="Password" onChangeText={(text)=>this.setState({password:text})} secureTextEntry={true}/>
                                    </View>
                                    <View style={{flex:1, marginTop:15, width:'100%', alignItems:'center', justifyContent:'center'}}>
                                        <TextInput style={{width:'90%', height:60}} underlineColorAndroid="#d8d8d8" placeholder="Konfirmasi Password" onChangeText={(text)=>this.setState({confirmPassword:text})} secureTextEntry={true}/>
                                    </View>
                                    <View style={{flex:1, marginTop:15, width:'100%', alignItems:'center', justifyContent:'center'}}>
                                    ...
                                    <View style={{flex:1, marginTop:20, width:'100%', alignItems:'center', justifyContent:'center'}}>
                                        <TouchableOpacity style={{flex:1, flexDirection:'row', alignContent:'flex-start', width:'85%'}} onPress={this.showDateTimePicker}>
                                            <View style={{flex:1}}>
                                                <Text style={{color: '#737373'}}>{this.state.birthDate == '' ?'Tanggal Lahir': newDate}</Text>
                                            </View>
                                        ...
                                        <DateTimePicker 
                                            ...
                                            onPress
                                        />
                                        <View style={{width:'88%', height:1, backgroundColor:'#d8d8d8', marginTop:15}} />
                                    </View>
                                        ...
                                        <View style={{flex:1, width:'100%',alignItems:'center', justifyContent:'center'}}>
                                            ...
                                            {gender.map(item=>
                                                <View key={item.key} style={{flex:1,flexDirection:'row', justifyContent:'center', alignItems:'center', marginBottom:30}}>
                                                    <TouchableOpacity 
                                                    style={{height:20, width:20, borderRadius:10, borderWidth:1, borderColor:'orange', alignItems:'center',justifyContent:'center'}}
                                                    onPress={()=>{this.setState({gender:item.key})}}
                                                    >
                                                        { this.state.gender === item.key && (<View style={{width:14, height:14, borderRadius:7, backgroundColor:'orange'}} />) }
                                                    </TouchableOpacity>
                                    ...
                                    <TouchableOpacity style={{padding:15, backgroundColor:'#d8d8d8', borderRadius:5, alignItems: 'center', justifyContent:'center', margin:15}} onPress={this.registerUser}>
                        ...
                        <ScrollView style={{padding:15}}>
                            <View style={{flex:1, alignItems: 'center', justifyContent:'center'}}>
                                <Text style={{fontSize:16, color:'#a7a9ab'}}>Ingin berjualan di lelevenia?</Text>
                                <Text style={{fontSize:20, color:'#000'}}>Daftar Sebagai Seller</Text>
